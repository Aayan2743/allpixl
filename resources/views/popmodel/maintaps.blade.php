<ul class="nav nav-pills nav-pills-custom mb-3" role="tablist">
    <li class="nav-item mb-3 me-3 me-lg-6 active" role="presentation">
        <a class="nav-link active btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
            id="kt_stats_widget_16_tab_link_1" data-bs-toggle="pill"
            href="#kt_stats_widget_16_tab_1" aria-selected="false" role="tab"
            tabindex="-1">
            {{-- dfjghdfkjghdfkghdfkjghdfk --}}
            <div class="nav-icon mb-3">
                {{-- <i class="ki-duotone ki-car fs-1">
                    ...
                    <img src="{{asset('icons/folowup.png')}}" />
            </div>
    ...
    <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
            ...
            href="#kt_stats_widget_16_tab_2" aria-selected="false" role="tab"
            tabindex="-1">
            <div class="nav-icon mb-3">
                {{-- <i class="ki-duotone ki-like fs-1">
                    <span class="path1"></span>
                    <span class="path2"></span></i> --}}
                    <img src="{{asset('icons/Leads.png')}}" />
            </div>
            <span class="nav-text text-gray-800 fw-bold">
                Leads
            </span>
    ...
    <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
            ...
            href="#kt_stats_widget_16_tab_3" aria-selected="false" role="tab"
            tabindex="-1">
            <div class="nav-icon mb-3">
