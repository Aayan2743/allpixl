                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-content-center">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <input class="form-control" placeholder="Template Name" wire:model="templatename" id="templatename"
                                ...
                                id="templatemessage" wire:model="templatemessage" style="height: 150px;"></textarea>
                                                ...
                                                <div class="d-flex  flex-shrink-0"> 
                                                    <button wire:click="update_changes({{$temp->templateid}})" 
                                                        ...
                                                        <img src={{asset('icons\ok.png')}} alt="dsfdsffsd" />
                                                         ...
                                                         <button wire:click="cancel({{$temp->templateid}})" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm "
                                                    > 
                                    ...
                                    <div class="d-flex flex-column w-100 me-2">
                                        <div class="d-flex flex-stack mb-2">
                                            ...
                                            <td class="align-content-center">
                                                ...
                                                <button wire:click="delete({{$temp->templateid }})" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm "
                                                    > 
