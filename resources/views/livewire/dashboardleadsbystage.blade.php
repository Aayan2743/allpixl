            ...
            <li class="nav-item p-0 ms-0 me-8" role="presentation">
                ...
                <!-- <a class="nav-link btn btn-color-muted px-0 active" data-bs-toggle="tab" id="kt_chart_widgets_22_tab_1"
                    ...
                    <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-900 m-0">Lead's By Stage's</span>
                    ...
                    <div class="me-md-5 w-100">
                        ...
                        <div class="d-flex border border-gray-300 border-dashed rounded p-4 mb-3">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                ...
                                <!--begin::Section-->
                                <div class="me-2">
                                    <h6 class="text-gray-800 fs-6 fw-bold"> {{$count->leadstagetext}}</h6> 
                                </div>
                                <!--end::Section-->
                            </div>
                            <!--end::Block-->
                            ...
                            <div class="d-flex align-items-center">
                                <span class="text-gray-900 fw-bolder fs-2x" style="text-align: -webkit-center;"> {{$count->count}}<span
                                        class="text-muted mt-1 fw-semibold fs-7"> </span></span>
