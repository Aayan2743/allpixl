                                ...
                                <div class="row g-5">
                                    <div class="col-6">
                                        <div
                                            class="sidebar-border-dashed d-flex flex-column justify-content-center rounded p-3 p-xxl-5">
                                             ...
                                             @elseif(last(request()->segments())=="followups")
                                                    <a href="" data-bs-toggle="modal"
                                                            data-bs-target="#kt_modal_invite_friendss">
                                                            <div class=" fs-6 fw-bold text-white text-center">Add Leads 
                                                            </div>
                                                         </a>
                                             @elseif(last(request()->segments())=="leads")
                                                    <a href="" data-bs-toggle="modal"
                                                            data-bs-target="#kt_modal_invite_friendsss">
                                                            <div class=" fs-6 fw-bold text-white text-center">Add Leads
                                                            </div>
                                                         </a>   
                                             @elseif(last(request()->segments())=="viewdeals")
                                                         <a href="" data-bs-toggle="modal"
                                                                 data-bs-target="#kt_modal_invite_friendssss">
                                                                 <div class=" fs-6 fw-bold text-white text-center">Add Leads
                                                                 </div>
                                                              </a>    
                                        ...
                                        @elseif(last(request()->segments())=="settings")
                                                                   <a href="" data-bs-toggle="modal"
                                                                           data-bs-target="#kt_modal_invite_friendssssss">
                                                                           <div class=" fs-6 fw-bold text-white text-center">Add Leads
                                                                           </div>
                                                                        </a>  
                                            @elseif(last(request()->segments())=="profile")
                                                                        <a href="" data-bs-toggle="modal"
                                                                                data-bs-target="#kt_modal_invite_friendsssssssss">
                                                                                <div class=" fs-6 fw-bold text-white text-center">Add Leads
                                                                                </div>
                                                                             </a>  
                                          @else
                                    ...
                                    <div class="col-6">
                                        <div
                                            ...
                                            <a href="{{route('admin.followups')}}">
                                                <div class=" fs-6 fw-bold text-white text-center">View
                                                    FollowUps</div>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div>
                                            <div class="row g-0">
                                                ...
                                                <a href="{{route('admin.leads')}}" >
                                                    ...
                                                    <a href="{{route('admin.leads')}}" class="text-primary fw-semibold fs-6 text-center" style="font-size:14px !important;">
                                                        Cold
                                                    </a>
                                    ...
                                    <div class="card-body py-0">
                                        ...
                                        <div class="d-flex flex-nowrap align-items-center mb-7">
                                            ...
                                            <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                <a href="{{route('admin.leads')}}" class="text-white fw-semibold text-hover-primary fs-6" style="text-transform: capitalize">{{$topleadsdata->customer}}</a>
                                            </div>
                                            <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                <a href="{{route('admin.leads')}}" class="text-white fw-semibold text-hover-primary fs-6" style="text-transform: capitalize">{{ \Carbon\Carbon::parse($topleadsdata->created_at)->diffForHumans()}}</a>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
