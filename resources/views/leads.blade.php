                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="customers" placeholder="Customer Name" value="N/A">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="dateInput" class="form-label">Delivery Date
                                                *</label>
                                            <input class="form-control form-control-solid" type="datetime-local"
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="u_Orginazation"
                                        placeholder="Orginazation Name" value="">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" id="u_leadsource">
                                        ...
                                        <option value="{{$leadssource->leadsource}}">{{$leadssource->leadsource}}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mt-3">
                                    <label for="dateInput" class="form-label">Phone *</label>
                                    <input type="text" class="form-control" id="tellphone" name="tellphone"
                                        aria-describedby="nameHelp">
                    ...
                    <div class="table-responsive" style=" width: -webkit-fill-available;">
                        <div class="container">
                            Are you sure you want to delete the lead <span
                                style="color: red; text-transform: capitalize" id="tesing1"></span>
...
<script>
    $(document).ready(function () {
        $('#filter').change(function () {
            var value = $(this).val();
            $('#tablesss tbody tr').each(function () {
                if ($(this).find('td:first').text().toLowerCase().indexOf(value) === -1 &&
                    value !== 'all') {
                    $(this).hide();
                } else {
                    $(this).show();
